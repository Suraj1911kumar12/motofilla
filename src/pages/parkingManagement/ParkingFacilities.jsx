...
const ParkingFacilities = () => {
  ...
  for (let i = 0; i < 18; i++) {
    data.push({
      ...
      action: [
        <div className="btn btn-success text-white px-7 py-1 w-28 me-5">
          Edit
        </div>,
        <div className="btn btn-error text-white px-7 py-1 w-28 ms-5">
          Delete
        </div>,
      ],
    });
    ...
    //     ),
    //     action: (
    //       <div className="btn btn-success text-white px-7 py-1 w-28">Edit</div>
    //     ),
    //   });
    // } else {
    //   data.push({
    ...
    //     ),
    //     action: (
    //       <div className="btn btn-error text-white px-7 py-1 w-28">Delete</div>
    //     ),
    //   });
    // }
  }
